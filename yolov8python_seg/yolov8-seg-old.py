...
# #this runs with the background removal
# def draw_masks(image, boxes, class_ids, mask_alpha=0.3, mask_maps=None):
...
class YOLOSeg:
    ...
    def extract_boxes(self, box_predictions):
        ...
        boxes = self.rescale_boxes(boxes,
                                   ...
                                   (self.img_height, self.img_width),True)
    ...
    def process_mask_output(self, mask_predictions, mask_output):
        ...
        for i in range(len(scale_boxes)):
            ...
            crop_mask = (crop_mask > 0.55).astype(np.uint8)
    ...
    # @staticmethod
    def rescale_boxes(boxes, input_shape, image_shape, divide=False):
