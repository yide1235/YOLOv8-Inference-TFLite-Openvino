...
#         # print(type(out.shape[1]*out.shape[2]))
#         # out=tf.reshape(out, (None, int(out.shape[1]*out.shape[2]), out.shape[3]))
#         out = tf.reshape(out, (-1, int(out.shape[1] * out.shape[2]), out.shape[3]))
